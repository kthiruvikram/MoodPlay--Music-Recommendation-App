        ...
        <div className="relative container mx-auto px-6 py-12">
          <div className="text-center space-y-6">
            ...
            <div className="space-y-4">
              <h1 className="text-[60px] font-bold tracking-tight text-primary">
                MoodPlay
              </h1>
              <p className="text-[60px] text-muted-foreground max-w-2xl mx-auto">
                Intelligent emotion-based music personalization platform powered by AI
              </p>
              
              <div className="flex items-center justify-center gap-6 pt-4">
                <div className="flex items-center gap-2 text-[60px]">
